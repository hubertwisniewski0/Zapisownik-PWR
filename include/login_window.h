...
class LoginWindow : public QDialog
{
  ...
  private:
    ...
    QString get_token(const QString &token, const QString &end_token,
                      QNetworkReply *reply);
    void process();
    ...
    void ZnajdzBlokiGrupyKursy(QTextStream &stream, const QString &nazwa,
                               const bool &nr);
  ...
  private:
    ...
    QCheckBox *AngA, *AngB, *AngC, *NiemA, *NiemB, *NiemC, *InneA, *InneB,
        *InneC, *stacjonarne, *niestacjonarne, *stopienI, *stopienII, *sekcja;
