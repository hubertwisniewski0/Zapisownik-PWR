...
PickColors::PickColors(QWidget *parent) : QDialog(parent)
{
    ...
    connect(KoloryJSOS, &ColorDoubleButton::leftClicked, this,
            &PickColors::JSOS_clicked);
    connect(KoloryPlanPWR, &ColorDoubleButton::leftClicked, this,
            &PickColors::PWR_clicked);
    connect(buttons, &QDialogButtonBox::accepted, this, &QDialog::accept);
    connect(buttons, &QDialogButtonBox::rejected, this, &QDialog::reject);

    connect(wyklady, &ColorDoubleButton::leftClicked, this,
            &PickColors::getColor);
    connect(wyklady, &ColorDoubleButton::rightClicked, this,
            &PickColors::getFontColor);
    connect(cwiczenia, &ColorDoubleButton::leftClicked, this,
            &PickColors::getColor);
    connect(cwiczenia, &ColorDoubleButton::rightClicked, this,
            &PickColors::getFontColor);
    connect(laborki, &ColorDoubleButton::leftClicked, this,
            &PickColors::getColor);
    connect(laborki, &ColorDoubleButton::rightClicked, this,
            &PickColors::getFontColor);
    connect(projekty, &ColorDoubleButton::leftClicked, this,
            &PickColors::getColor);
    connect(projekty, &ColorDoubleButton::rightClicked, this,
            &PickColors::getFontColor);
    connect(seminaria, &ColorDoubleButton::leftClicked, this,
            &PickColors::getColor);
    connect(seminaria, &ColorDoubleButton::rightClicked, this,
            &PickColors::getFontColor);
    connect(inne, &ColorDoubleButton::leftClicked, this, &PickColors::getColor);
    connect(inne, &ColorDoubleButton::rightClicked, this,
            &PickColors::getFontColor);
...
{
    bt->setStyleSheet(QString("background-color: %1; color: %2;")
                          .arg(bt->color().name())
                          .arg(bt->fontColor().name()));
}
...
void PickColors::setColorCwiczenia(const QColor &clr)
{
    cwiczenia->setColor(clr);
}
void PickColors::setColorLaborki(const QColor &clr) { laborki->setColor(clr); }
void PickColors::setColorProjekty(const QColor &clr)
{
    projekty->setColor(clr);
}
void PickColors::setColorSeminaria(const QColor &clr)
{
    seminaria->setColor(clr);
}
