...
void Window::ustawDzienNaSiatce(QString dzien, int row, int col, int rowSpan,
                                int colSpan)
{
...
void Window::drawCourse(int row, int tydzien, int column, int length,
                        QString grupa, QString text, QColor color,
                        QColor fcolor, QString kKursu, QString czas,
                        QString prowadzacy)
{
    ...
    if (tydzien == 0)
        ...
        czas += "     TP";
    czas += "\n" + text;
    prowadzacy = usun_tagi(prowadzacy);
    czas += "\n" + prowadzacy;
    ...
    {
        siatka->addWidget(blok, row * 3 + 2 + tydzien, column, rowSpan,
                          length / 5 + 1);
        blok->setText(czas);
    }
    else
    {
        ...
        siatka->addWidget(blok, column, row * 3 + 2 + tydzien, length / 5 + 2,
                          rowSpan);
        blok->setText(czas);
    }
